...
<div className="">
  ...
  <div class="flex flex-col items-center ml-180 justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
              ...
              <form class="space-y-4 md:space-y-6" action="#">
                  <div className='flex flex-row gap-5'>
                    <div className="">
                      ...
                      <input type="text" name="Name" id="FirstName" class="bg-gray-150 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder="FirstName" required=""></input>
                      </div>
                      <div className="">
                      <label for="LastName" class="block mb-2 text-sm font-medium text-gray-900">LastName</label>
                      <input type="text" name="email" id="LastName" class="bg-gray-150 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder="LastName" required=""></input>
                      </div>
                  </div>
                  <div className="">
                      <label for="email" class="block mb-2 text-sm font-medium text-gray-900">Email</label>
                      <input type="email" name="email" id="email" class="bg-gray-150 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder="example123@gmail" required=""></input>
                      </div>
                  ...
                  <div>
                      <label for="password" class="block mb-2 text-sm font-medium text-gray-900">Re-Password</label>
                      <input type="password" name="password" id="re-password" placeholder="••••••••" class="bg-gray-150 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required=""></input>
                  </div>
                  ...
                  <p class="text-sm font-light text-gray-700 ">
                      Don’t have an account yet? <a onClick={Signup} href="#" class="font-medium text-green-600 hover:underline dark:text-green-500">Log In </a>
                  </p>
              </form>
          </div>
      </div>
