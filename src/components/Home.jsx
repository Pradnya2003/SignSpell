...
import page from "../assets/CLAP (2).jpeg";
...
>
  ...
  <div className="relative z-10 flex flex-col justify-center items-start h-full px-4  sm:px-6 md:px-10 lg:px-20 py-20">
    ...
    >
      ...
      {/* Services Section */}
      <section id="OurTeam" className=" bg-gray-100 py-12 px-60">
        <div className=" w-[1000px] h-auto ">
          {/* Section Title */}
          <p className="text-green-500 text-left pt-10 text-[17px]">Sign language translation</p>
          <h2 className="text-[39px] font-bold text-left text-gray-800 pb-8">
            OUR TEAM
          </h2>
          
          {/* Step Cards */}
          <div className="flex justify-center items-center p-20 pr-10 gap-10 md:">
            {/* Step 1: Voice Translation */}
            <div  className=" bg-white w-75 h-80 rounded-lg shadow-lg text-center hover:scale-105 transition-transform">
              <img className="h-70 w-100 mx-auto" src={pic} alt="Voice Translation" />
              <div  className="text-xl p-6 gap-8 text-left ">
              <h1 className="text-[20px] font-semibold flex hover:text-green-300 transition-colors mb-2">Mrs. Kavitha M
 </h1>
          ...
          {/* grid on the second line */}
           <div className="grid grid-cols-4 justify-center items-center   gap-10  md:">
            {/* cards */}
            <div onClick={Text} className="w-60 h-75 bg-white rounded-lg shadow-lg text-center  transition-transform">
              <img className="h-60 w-100 mx-auto" src={pradnya} alt="Text Translation" />
              <div className="text-xl p-6 text-left">
              <h1 className="text-[20px] font-semibold flex justify-center items-center text-green-500 transition-colors mb-2">PRADNYA K T </h1>
              
              </div>
            </div>
          <div onClick={Video} className="w-60 h-75 bg-white rounded-lg shadow-lg text-center  transition-transform">
              <img className="h-60 w-100 mx-auto" src={sms} alt="Video Translation" />
              <div className="text-xl p-6 text-left">
            <h1 className="text-[20px] font-semibold flex justify-center items-center text-green-500 transition-colors mb-2">SRI MATHI S</h1>
                
              </div>
            </div>
            <div onClick={Text} className="w-60 h-75 bg-white rounded-lg shadow-lg text-center  transition-transform">
              <img className="h-60 w-100 mx-auto" src={srini} alt="Text Translation" />
              <div className="text-xl p-6 text-left">
              <h1 className="text-[20px] font-semibold flex justify-center items-center text-green-500 transition-colors mb-2">SRINIVASAN R </h1>
              
              </div>
            </div>
            <div onClick={Text} className="w-60 h-75 bg-white rounded-lg shadow-lg text-center  transition-transform">
              <img className="h-60 w-100 mx-auto" src={surya} alt="Text Translation" />
              <div className="text-xl p-6 ">
              <h1 className="text-[20px] font-semibold flex justify-center items-center text-green-500  transition-colors mb-2">SURYA B</h1>
      ...
      <section className="bg-black py-10">
        <h3 className="text-green-400 text-center pt-5 text-2xl font-bold">SIGN SPELL</h3>
        <div className="flex flex-row justify-center pt-5 gap-9 text-white">
        ...
        <div className="flex justify-center items-center gap-3 pt-5">
          ...
          <a href="https://x.com/?lang=en" target="_blank" rel="noopener noreferrer">
            <img className="h-[25px] w-[25px]" src={x} alt="X" />
          </a>

        </div>
        <a href="https://saisurya7860.github.io/SignSpell/" target="_blank" className="text-white flex items-center justify-center">Check the Sign spell application</a>
      </section>
    </div>
  );
}
